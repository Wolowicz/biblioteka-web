export const theme = {
  admin: {
    bg: "bg-[#1d1d1f] text-gray-100",
    card: "bg-[#1c1c1c] border border-gray-600",
    link: "text-blue-300",
  },

  librarian: {
    bg: "bg-gray-100 text-gray-900",
    card: "bg-gray-200 border border-gray-300",
...
export const roleUI = {
  ADMIN: {
    background: "bg-[#121212] text-gray-100 min-h-screen",
    text: "text-gray-100",
  },
  LIBRARIAN: {
...
export const panelUI = {
  ADMIN: {
    card: "bg-[#1c1c1c] border border-gray-700 p-6 rounded-2xl",
  ...
  LIBRARIAN: {
    card: "bg-gray-200 border border-gray-300 p-6 rounded-2xl",
...
export const reserveUI = {
  base: "px-4 py-2 rounded-xl font-semibold text-white bg-indigo-600 hover:bg-indigo-500 disabled:bg-gray-400 disabled:cursor-not-allowed transition",
  success: "mt-2 text-green-600 font-medium",
  error: "mt-2 text-red-600 font-medium",
};

export const backUI = {
  base: "px-4 py-2 rounded-lg bg-gray-200 hover:bg-gray-300 text-gray-800 font-medium transition",
};
